...
const data={
    ...
    qna: [
        ...
        {
            q: "How to play- step by step guide (video)",
            di: {__html: guide}
        },
        {
        ...
        {
            q: "About Upstox Section/Start Investing section?",
            a: "Upstox makes trading easy and is your one-stop destination for stocks, mutual funds, futures & options, and more. Not only is it simple to understand, it’s also convenient allowing you to trade from anywhere. With flat brokerage charges, if you haven’t already joined in, start investing now!"
        },
        {
